...
typedef enum
{
	...
	/** @brief @~chinese 分辨率 3072X2048 @~english Resolution 3072X2048 */
	IMAGEOUT_MODE_3072X2048 = 20,
...
typedef struct _tDevLoadMode
{
	...
	uint32_t BlackLevel;
	/** @brief @~chinese 是否开启坏点修正 @~english Enable correct dead pixel */
	uint8_t  EnableCorrectDeadPixel;
